...
export default class StockWidget extends HTMLElement {
  ...
  render() {
    ObservabilityManager.getInstance().withSpan('widget.render', (span) => {
      if (this.shadowRoot === null) return
      span.setAttribute('component', 'StockWidget')
      ...
      // Show loading state
      if (
        this.data.companyOverview === null ||
        this.data.globalQuote === null
      ) {
        this.shadowRoot.innerHTML = `
            ${style}
